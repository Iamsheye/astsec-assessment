  ...
  return (
    ...
    >
      <button
        ...
        className={`absolute -right-4 top-6 grid h-8 w-8 place-content-center rounded-full border-[3px] border-gray-50 bg-[#00732E] ${isCollapsed ? "hidden group-hover:grid" : "grid"} duration-300`}
      >
        <svg
          width="8"
          height="14"
      ...
      >
        {isCollapsed ? (
          <Image src={"/logo.svg"} alt="Astelia Logo" width={32} height={32} />
        ) : (
          <Image
            src={"/logo-full.svg"}
            alt="Astelia Logo"
